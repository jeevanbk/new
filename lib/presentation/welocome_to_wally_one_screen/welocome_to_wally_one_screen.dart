...
class WelocomeToWallyOneScreen extends GetWidget<WelocomeToWallyOneController> {
            ...
            child: Column(
              ...
              children: [
                ...
                CustomTextFormField(
                  width: 299,
                  focusNode: FocusNode(),
                  controller: controller.groupSixtyFiveController,
                  hintText: "lbl_e_mail".tr,
                  margin: getMargin(
                    top: 47,
                  ),
                  variant: TextFormFieldVariant.OutlineLightgreen100,
                  padding: TextFormFieldPadding.PaddingAll12,
                  fontStyle: TextFormFieldFontStyle.RobotoRomanSemiBold16,
                ...
                CustomButton(
                  ...
                  variant: ButtonVariant.OutlineDeeporange5001,
                  fontStyle: ButtonFontStyle.RobotoRomanBold14,
                ),
              ],
            ),
          ),
